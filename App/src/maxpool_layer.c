...
*/
maxpool_layer make_maxpool_layer(int batch, int h, int w, int c, int size, int stride, int padding, int sgx)
{
    maxpool_layer l = {0};
    ...
    l.out_h = (w + 2*padding - size) / stride + 1;
    ...
    if(l.sgx)
        l.forward = e_forward_maxpool_layer;
    else
