...
convolutional_layer parse_convolutional(list *options, size_params params)
{
    ...
    convolutional_layer layer = make_convolutional_layer(sgx, batch,h,w,c,n,size,stride,padding,activation, batch_normalize, binary, xnor, params.net.adam);
...
connected_layer parse_connected(list *options, size_params params)
{
    ...
    int batch_normalize = option_find_int_quiet(options, "batch_normalize", 0);
    int sgx = option_find_int_quiet(options, "sgx", 1);
    connected_layer layer = make_connected_layer(params.batch, params.inputs, output, activation, batch_normalize, sgx);
...
maxpool_layer parse_maxpool(list *options, size_params params)
{
    ...
    maxpool_layer layer = make_maxpool_layer(batch,h,w,c,size,stride,padding, sgx);
    return layer;
}
...
dropout_layer parse_dropout(list *options, size_params params)
{
    ...
    int sgx = option_find_int_quiet(options, "sgx", 1);
    dropout_layer layer = make_dropout_layer(params.batch, params.inputs, probability, sgx);
...
network parse_network_cfg(char *filename)
{
    ...
    while(n){
        ...
        l.sgx = option_find_int_quiet(options, "sgx", 1);
